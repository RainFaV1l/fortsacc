      ...
      <div class="flex flex-col gap-[30px]">
        ...
        <div class="flex items-center gap-[40px]">
          ...
          <div class="flex items-center gap-[15px] w-[87%]">
            <input class="text-[14px] px-[25px] py-[24px] bg-[rgba(17,16,11,.3)] border border-[#897CFF] rounded-[10px] w-[74%]" type="text" :value="appUrl + 'register/' + userStore.user.referral_link">
            <ButtonComponent class="py-[22px] px-[78px]" type="blue">Copy link</ButtonComponent>
          </div>
        </div>
      </div>
    </div>
